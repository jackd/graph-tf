...
def get_conv_args():
    ...
    w = rng.normal((FLAGS.e, FLAGS.fi, FLAGS.fo))
...
class GCNOpsBenchmark(Benchmark):
    ...
    def v1(self, backwards):
        return do_conv(ops.spectral_graph_conv_v1, backwards=backwards)

    @benchmark
    def v2(self, backwards):
        return do_conv(ops.spectral_graph_conv_v2, backwards=backwards)
